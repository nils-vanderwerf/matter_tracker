...
matters = [
  ...
  Matter.create!(client: chen, title: "Chen Associates — Shareholder Agreement Review", matter_type: "Commercial", status: "Closed", due_date: Date.today - 10, description: "Review and redraft of shareholder agreement following entry of new investors."),
...
[
  ...
  { matter: matters[1], title: "File IVO application at Magistrates Court", priority: "High", status: "Completed", due_date: Date.today - 2, description: "Filed — receipt obtained." },
  ...
  { matter: matters[2], title: "Review lease agreement", priority: "High", status: "Completed", due_date: Date.today - 5, description: "Reviewed 2019 commercial lease — relevant clauses identified." },
  ...
  { matter: matters[5], title: "Review contract of sale", priority: "High", status: "Completed", due_date: Date.today - 3, description: "Contract reviewed — special conditions noted." },
  { matter: matters[5], title: "Conduct title searches", priority: "High", status: "Completed", due_date: Date.today - 3, description: "Title clear — no encumbrances." },
